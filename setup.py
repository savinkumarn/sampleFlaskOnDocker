...
setup(
    name='py_mon_api',
    version='1.0',
    packages=['venv.lib.python3.6.site-packages.bson', 'venv.lib.python3.6.site-packages.click',
              ...
              'venv.lib.python3.6.site-packages.pymongo', 'venv.lib.python3.6.site-packages.werkzeug',
